...
# 2026-08-10 修复：日志提交必须显式指定接收人（dws 不自动带模板预设接收人，缺了 read_number=0 无人收到）。
# 模板接收人清单（15 人，用户截图确认含王祎本人）：胡佳、郑炎城、张斐、兆汇、周文君、杨桥、杨志、高应婷、王莹、陆雨阳、沈超、向家祥、王祎、汪玉琴、沈阳
REPORT_TO_USER_IDS = ("01104268151043122,01231127491636542865,2212601849794046,014229691438662957,"
                      "024908435521592540,0455536261847357,0501643723845167,064243141938867771,"
                      "0917545705950670,101501180838205713,1352305732897533,154338120021440576,"
                      "17566881508928543,223666541827618229,2260394838899755")
