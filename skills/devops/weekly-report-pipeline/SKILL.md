...
| **181-270天库存目标** | 当前库存 × **0.5** | 库龄清货目标 |
| **271-365天库存目标** | 当前库存 × **0.3** | 库龄清货目标 |
| **366天以上库存目标** | 当前库存 × **0.1** | 库龄清货目标 |
...
| E: 90-180天目标存量 | target_90_180 | current × 0.8 |
| F: 清货效率 | target / current | 自动计算 |
| G: 181-270天当前存量 | inv_181_270 | FBA库存聚合 |
| H: 181-270天目标存量 | target_181_270 | current × 0.5 |
